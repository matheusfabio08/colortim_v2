...
export const laboratoryService = {
  ...
  async getRecords() {
    const { rows } = await db.query(`
      SELECT po.*, lab.id as lab_record_id, lab.num_batches, lab.is_recipe_ready, lab.recipe_origin_date,
             lab.description as lab_description, lab.is_approved, lab.start_time as lab_start_time,
             lab.end_time as lab_end_time, lab.created_at as lab_processed_at
