...
export const productionService = {
  async complete(input: z.infer<typeof ProductionSchema>, userId: string): Promise<void> {
    await db.transaction(async (client) => {
      await client.query(`INSERT INTO po_production (op_id,box_number,machine,operator,has_adjustment,start_date,end_date,meters_produced) VALUES ($1,$2,$3,$4,$5,$6,$7,$8)`,
