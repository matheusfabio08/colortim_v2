                ...
                {filteredOPs && filteredOPs.length > 0 ? (
                  filteredOPs.map((op) => (
                    <tr key={op.id} className="hover:bg-gray-50 transition-colors">
                      <td className="px-3 py-2 whitespace-nowrap"><span className="font-semibold text-blue-600">{op.op_number}</span></td>
                      ...
                      <td className="px-3 py-2 whitespace-nowrap text-gray-600">{format(new Date(op.expected_date), "dd/MM/yyyy", { locale: ptBR })}</td>
